# cp202-shopping-cart
This shopping cart was created to support my teaching of CP202. It uses Bootstrap styles and JQuery.

## Shopping Cart
This shopping cart uses window.localStorate to store items. It is self contained, and it but it needs some imports. To added to any page, add the following code:
